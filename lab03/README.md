...
> Да, подсеть на данный момент является приватной, потому что у неё нет маршрута к Internet Gateway.
> Без такого маршрута трафик не может выходить в Интернет.
> Следовательно, все ресурсы внутри этой подсети изолированы внутри VPC.
